  ...
  return (
    <footer className="mt-16 border-t border-slate-200 bg-slate-950 text-slate-200">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div>
          <h3 className="text-lg font-semibold text-white">HopeSpring Foundation</h3>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-slate-300">
            <li className="flex items-start gap-2">
              ...
              <span>12 Community Lane, Bengaluru, India</span>
            </li>
            ...
            <li className="flex items-center gap-2">
              <Mail size={16} />
              <span>hello@hopespring.org</span>
            </li>
          </ul>
      ...
      <div className="border-t border-slate-800 px-4 py-4 text-center text-xs text-slate-400">
        Copyright {new Date().getFullYear()} HopeSpring Foundation. All rights reserved.
      </div>
    </footer>
  );
}
